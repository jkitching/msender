(function(){
    ...
    app.controller('msenderController', ['$scope', '$http', function($scope, $http) {
        ...
        this.update = function() {
            ...
            this.body +="Après les révélations sur les conditions d'abattage des animaux à l'abattoir d'Alès, L214 révèle de nouvelles violences exercées sur des moutons, cochons et bovins dans l'abattoir intercommunal certifié bio du Vigan (Gard). \n\n";
            this.body +="Ces deux enquêtes de grande ampleur sont la preuve que d'importants dysfonctionnements existent dans les abattoirs français.\n\n";
            this.body +="Face à cette situation et au vu de l’indignation suscitée par ces images, je me joins à l'association L214 pour demander l'ouverture d'une commission d'enquête parlementaire afin de faire toute la lumière sur les pratiques des abattoirs français trop longtemps dissimulées au public. En tant que parlementaire, vous pouvez déposer une proposition de résolution allant dans ce sens.\n\n";
